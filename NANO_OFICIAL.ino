...
void valor_sensor(){
  ...
  tensao_bat_INA = (float)rawVoltage * 0.001251506343; //Esse valor que está sendo multiplicado pelo valor da tensão tem a função de calibrar o sensor.
  // Vbat = Vina *      1.29411765       *    0,967073081    *   0.001
  // Vbat = Vina * fatorDivisorTensao * fatorCorreção * fatorMili
  /*______________________________________________________________________*/

  /*__________________Sensor de Corrente INA______________________________*/
  
  rawCurrent = INA.getShuntMicroVolts();                
  corrente_motor_INA = (float)rawCurrent * 0.0010388247408; //Esse valor que está sendo multiplicado pelo valor da corrente tem a função de calibrar o sensor.
  // Imotor = (Iina * 10^-6 / 0.001) * 0.69113815
  // Imotor = (Iina * fatorMicroVolt / valorShunt) * fatorCorreção
  /*______________________________________________________________________*/
