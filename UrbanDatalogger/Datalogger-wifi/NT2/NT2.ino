...
TinyGPSPlus gps; // O tradutor de NMEA
...
void loop() {
  ...
  if(millis() - lastTimer >= 400){
    ...
    snprintf(payload, sizeof(payload),
             "{\"AceleraMPU\":%.2f,\"Altura\":%.1f,\"InclinacaoMPU\":%.2f,\"RotacaoMPU\":%.2f,\"AceleraICM\":%.2f,\"InclinacaoICM\":%.2f,\"RotacaoICM\":%.2f,\"LatitudeGPS\":%.6f,\"LongitudeGPS\":%.6f}",
             mediaAccX_MPU, mediaA, mediaAngY_MPU, mediaAngZ_MPU, 
             mediaAccY_ICM, mediaAngX_ICM, mediaAngZ_ICM, currentLat, currentLon);
